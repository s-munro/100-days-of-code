...
**Thoughts:** Looking to get back into programming and hone in on some of my skills.  I would like to complete the course mentioned in "Today's Progress" to become more advanced, get a deeper feel for tech and programming.  I'm wanting to jump into a tech job soon, so I'm diving back in head-first.  Follow along, here we go!
...
**Today's Progress**: We in it baby.  Proud of myself for today.. But first, it's pretty wild that it's already the 29th of the month.  Let me not get sidetracked though:
